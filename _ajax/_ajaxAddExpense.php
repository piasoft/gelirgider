<?php 
	...
	if(isset($_POST['frm']) and $_POST['frm']=='frmAddExpense'){
			...
			if($pia->insert("INSERT INTO finances(u_id, category_id, customer_id, price, method_id, event_type, description, adddate) VALUES($admin->id, $category_id, $customer_id, $price, $method_id, $event_type, $description, $adddate)")){
